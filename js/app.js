  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `
              <div class="col single-product">
                <div class="card h-100" style="background-color: #e0f1f0;
                border-radius: 10px;">
                    <div style="background-color: #e0f1f0; display:flex;">
                      <img class="product-image pt-3 mx-auto" src=${image}></img>
                    </div>
                    <div class="card-body">
...
const addToCart = (id, price) => {
  count = count + 1;
  updatePrice("price", price);//update price call

  updateTaxAndCharge();//update tax and charge call
  updateTotal(); //update total call
...
const updatePrice = (id, value) => {
  ...
  document.getElementById(id).innerText = total.toFixed(2); //set two decimal place
};

// set innerText function
const setInnerText = (id, value) => {
  document.getElementById(id).innerText = value.toFixed(2); //set two decimal place
};
...
const updateTotal = () => {
  ...
  document.getElementById("total").innerText = grandTotal.toFixed(2); //set two decimal place
};
loadProducts();